...
@section('contentSeccion')
  
<!-- Page content-->
      <!-- Hero + Search form-->
      <section class="bg-position-top-center bg-repeat-0 pt-5" style="background-image: url({{ asset('img/img/car-finder/home/hero-bg.png') }}); background-size: 1920px 630px;">
        <div class="container pt-5">

          <div class="row pt-lg-4 pt-xl-5">
            <div class="col-lg-4 col-md-5 pt-3 pt-md-4 pt-lg-5">
              <h1 class="display-4 text-light pb-2 mb-4 me-md-n5">Una forma sencilla de encontrar el coche ideal</h1>
              <p class="fs-lg text-light opacity-70">Poma-Car es una plataforma digital líder en la industria automotriz que conecta a compradores y vendedores de coches. </p>
            </div>


            <div class="col-lg-8 col-md-7 pt-md-5">
                {{-- <img class="d-block mt-4 ms-auto" src="{{ asset('img/img/car-finder/home/hero-img.png') }}" width="800" alt="Car"> --}}
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-wrap="true" data-bs-interval="5000">
                        ...
                        <div class="carousel-inner" style="height: 400px">
                            <div class="carousel-item active">
                                <img src="{{ asset('img/img/car-finder/home/hero-img.png') }}" class="d-block w-100" style="object-fit: cover; height: 100%; " width="800" alt="Imagen 1">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('img/img/car-finder/catalog/carucel/03.png') }}" class="d-block w-100" style="object-fit: cover; height: 100%; width: 100%;" alt="Imagen 2">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('img/img/car-finder/catalog/carucel/12.png') }}" class="d-block w-100" style="object-fit: cover; height: 100%; width: 100%;" alt="Imagen 3">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('img/img/car-finder/catalog/carucel/14.png') }}" class="d-block w-100" style="object-fit: cover; height: 100%; width: 100%;" alt="Imagen 4">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('img/img/car-finder/catalog/carucel/16.png') }}" class="d-block w-100" style="object-fit: cover; height: 100%; width: 100%;" alt="Imagen 5">
                            </div>
                        </div>
        ...
        <div class="container mt-4 mt-sm-3 mt-lg-n3 pb-5 mb-md-4">
          ...
          <ul class="nav nav-tabs nav-tabs-light mb-4">
            ...
            <li class="nav-item"><a class="nav-link" href="#">Usado</a></li>
          </ul>
          <!-- Form group-->
            ...
            <div class="row g-0 ms-lg-n2">
              <div class="col-lg-2">
                <div class="input-group border-end-lg border-light"><span class="input-group-text text-muted ps-2 ps-sm-3"><i class="fi-search"></i></span>
                  <input class="form-control" type="text" name="keywords" placeholder="Buscar...">
                </div>
              </div>
              <hr class="hr-light d-lg-none my-2">
              <div class="col-lg-2 col-md-3 col-sm-6">
                <div class="dropdown border-end-sm border-light" data-bs-toggle="select">
                  <button class="btn btn-link dropdown-toggle ps-2 ps-sm-3" type="button" data-bs-toggle="dropdown"><i class="fi-list me-2"></i><span class="dropdown-toggle-label">Marca</span></button>
              ...
              <div class="col-lg-2 col-md-3 col-sm-6">
                <div class="dropdown border-end-md border-light" data-bs-toggle="select">
                  <button class="btn btn-link dropdown-toggle ps-2 ps-sm-3" type="button" data-bs-toggle="dropdown"><i class="fi-list me-2"></i><span class="dropdown-toggle-label">Modelo</span></button>
              ...
              <div class="col-lg-2 col-md-3 col-sm-6">
                <div class="dropdown border-end-sm border-light" data-bs-toggle="select">
                  <button class="btn btn-link dropdown-toggle ps-2 ps-sm-3" type="button" data-bs-toggle="dropdown"><i class="fi-car fs-lg me-2"></i><span class="dropdown-toggle-label">Tipo de Cuerpo</span></button>
              ...
              <hr class="hr-light d-sm-none my-2">
                {{-- <div class="col-lg-2 col-md-3 col-sm-6">
                    ...
                    <button class="btn btn-link dropdown-toggle ps-2 ps-sm-3" type="button" data-bs-toggle="dropdown"><i class="fi-map-pin me-2"></i><span class="dropdown-toggle-label">Ubicacion</span></button>
                    <input type="hidden" name="location">
                    <ul class="dropdown-menu dropdown-menu-dark">
                        <li><a class="dropdown-item" href="#"><span class="dropdown-item-label">La Paz</span></a></li>
                        <li><a class="dropdown-item" href="#"><span class="dropdown-item-label">Oruro</span></a></li>
                        <li><a class="dropdown-item" href="#"><span class="dropdown-item-label">Cochabamba</span></a></li>
      ...
      {{-- segunda seccion imagens --}}
      <section class="container pb-5 mb-md-4">
        <div class="d-sm-flex align-items-center justify-content-between mb-3 mb-sm-4 pb-sm-2">
          <h2 class="h3 text-light mb-2 mb-sm-0">Caros Populares...</h2>
          <a class="btn btn-link btn-light fw-normal px-0" href="car-finder-catalog-grid.html">Ver Todo<i class="fi-arrow-long-right fs-sm mt-0 ps-1 ms-2"></i></a>
        </div>
        <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 g-2 g-md-4">
          ...
          <div class="col">
            <div class="card card-body card-light card-hover bg-transparent border-0 px-0 pt-0 text-center">
                <img class="d-block mx-auto mb-3" src="{{ asset('img/img/car-finder/icons/sedan.svg') }}" width="160" alt="Sedan">
                <a class="nav-link-light stretched-link fw-bold" href="car-finder-catalog-list.html">Sedan</a></div>
          </div>
          <!-- Item-->
          <div class="col">
            <div class="card card-body card-light card-hover bg-transparent border-0 px-0 pt-0 text-center">
                <img class="d-block mx-auto mb-3" src="{{ asset('img/img/car-finder/icons/suv.svg') }}" width="160" alt="SUV">
                <a class="nav-link-light stretched-link fw-bold" href="car-finder-catalog-grid.html">SUV</a></div>
          </div>
          <!-- Item-->
          <div class="col">
            <div class="card card-body card-light card-hover bg-transparent border-0 px-0 pt-0 text-center">
                <img class="d-block mx-auto mb-3" src="{{ asset('img/img/car-finder/icons/wagon.svg') }}" width="160" alt="Wagon">
                <a class="nav-link-light stretched-link fw-bold" href="car-finder-catalog-list.html">Wagon</a></div>
          </div>
          <!-- Item-->
          <div class="col">
            <div class="card card-body card-light card-hover bg-transparent border-0 px-0 pt-0 text-center">
                <img class="d-block mx-auto mb-3" src="{{ asset('img/img/car-finder/icons/crossover.svg') }}" width="160" alt="Crossover">
                <a class="nav-link-light stretched-link fw-bold" href="car-finder-catalog-grid.html">Crossover</a></div>
          </div>
          <!-- Item-->
          <div class="col">
            <div class="card card-body card-light card-hover bg-transparent border-0 px-0 pt-0 text-center">
                <img class="d-block mx-auto mb-3" src="{{ asset('img/img/car-finder/icons/coupe.svg') }}" width="160" alt="Coupe">
                <a class="nav-link-light stretched-link fw-bold" href="car-finder-catalog-list.html">Coupe</a></div>
          </div>
          <!-- Item-->
          <div class="col">
            <div class="card card-body card-light card-hover bg-transparent border-0 px-0 pt-0 text-center">
                <img class="d-block mx-auto mb-3" src="{{ asset('img/img/car-finder/icons/pickup.svg') }}" width="160" alt="Pickup">
                <a class="nav-link-light stretched-link fw-bold" href="car-finder-catalog-grid.html">Pickup</a></div>
          </div>
          <!-- Item-->
          <div class="col">
            <div class="card card-body card-light card-hover bg-transparent border-0 px-0 pt-0 text-center">
                <img class="d-block mx-auto mb-3" src="{{ asset('img/img/car-finder/icons/sport.svg') }}" width="160" alt="Sport Coupe">
                <a class="nav-link-light stretched-link fw-bold" href="car-finder-catalog-list.html">Sport Coupe</a></div>
          </div>
          <!-- Item-->
          <div class="col">
            <div class="card card-body card-light card-hover bg-transparent border-0 px-0 pt-0 text-center">
                <img class="d-block mx-auto mb-3" src="{{ asset('img/img/car-finder/icons/compact.svg') }}" width="160" alt="Compact">
                <a class="nav-link-light stretched-link fw-bold" href="car-finder-catalog-grid.html">Compact</a></div>
          </div>
          <!-- Item-->
          <div class="col">
            <div class="card card-body card-light card-hover bg-transparent border-0 px-0 pt-0 text-center">
                <img class="d-block mx-auto mb-3" src="{{ asset('img/img/car-finder/icons/convertible.svg') }}" width="160" alt="Convertible">
                <a class="nav-link-light stretched-link fw-bold" href="car-finder-catalog-list.html">Convertible</a></div>
          </div>
          <!-- Item-->
          <div class="col">
            <div class="card card-body card-light card-hover bg-transparent border-0 px-0 pt-0 text-center">
                <img class="d-block mx-auto mb-3" src="{{ asset('img/img/car-finder/icons/mpv.svg') }}" width="160" alt="Family MPV">
                <a class="nav-link-light stretched-link fw-bold" href="car-finder-catalog-grid.html">Family MPV</a></div>
          </div>
        </div>
      </section>
          ...
          <div class="col-lg-6">
            ...
            <div class="card card-light card-hover h-lg-100 mb-4 mb-lg-0">
              <div class="tns-carousel-wrapper card-img-top card-img-hover"><a class="img-overlay" href="car-finder-single.html"></a>
                ...
                <div class="tns-carousel-inner"><img src="{{ asset('img/img/car-finder/catalog/17.jpg') }}" alt="Image"><img src="{{ asset('img/img/car-finder/catalog/17.jpg') }}" alt="Image"></div>
              </div>
              <div class="card-body">
          ...
          <div class="col-lg-6">
            ...
            <div class="card card-light card-hover card-horizontal mb-4">
              <div class="tns-carousel-wrapper card-img-top card-img-hover"><a class="img-overlay" href="car-finder-single.html"></a>
                ...
                <div class="tns-carousel-inner position-absolute top-0 h-100">
                  <div class="bg-size-cover bg-position-center w-100 h-100" style="background-image: url({{ asset('img/img/car-finder/catalog/09.jpg') }});"></div>
                  <div class="bg-size-cover bg-position-center w-100 h-100" style="background-image: url({{ asset('img/img/car-finder/catalog/09.jpg') }});"></div>
                </div>
              </div>
              <div class="card-body">
            ...
            <div class="card card-light card-hover card-horizontal">
              <div class="tns-carousel-wrapper card-img-top card-img-hover"><a class="img-overlay" href="car-finder-single.html"></a>
                ...
                <div class="tns-carousel-inner position-absolute top-0 h-100">
                  <div class="bg-size-cover bg-position-center w-100 h-100" style="background-image: url({{ asset('img/img/car-finder/catalog/13.jpg') }});"></div>
                  <div class="bg-size-cover bg-position-center w-100 h-100" style="background-image: url({{ asset('img/img/car-finder/catalog/13.jpg') }});"></div>
                </div>
              </div>
              <div class="card-body">
      ...
      <section class="container py-2 py-sm-3">
        <div class="row g-2 g-sm-4">
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/opel.svg') }}" width="86" alt="Opel"></a></div>
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/audi.svg') }}" width="86" alt="Audi"></a></div>
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/mercedes.svg') }}" width="86" alt="Mercedes-Benz"></a></div>
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/toyota.svg') }}" width="86" alt="Toyota"></a></div>
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/mazda.svg') }}" width="86" alt="Mazda"></a></div>
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/nissan.svg') }}" width="86" alt="Nissan"></a></div>
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/hyundai.svg') }}" width="86" alt="Hyundai"></a></div>
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/lexus.svg') }}" width="86" alt="Lexus"></a></div>
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/honda.svg') }}" width="86" alt="Honda"></a></div>
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/renault.svg') }}" width="86" alt="Renault"></a></div>
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/infiniti.svg') }}" width="86" alt="Infiniti"></a></div>
          <div class="col-3 col-sm-2 col-xl-1 mb-4 pb-2"><a class="opacity-40 opacity-transition d-table mx-auto" href="#"><img src="{{ asset('img/img/car-finder/brands/mitsubishi.svg') }}" width="86" alt="Mitsubishi"></a></div>
        </div>
      </section>
      <!-- Features-->
        ...
        <div class="row">
          ...
          <div class="col-md-2 d-none d-md-block">
            <div class="position-relative mx-auto h-100" style="max-width: 5rem; min-height: 26rem;">
              <div class="rellax content-overlay pt-5" data-rellax-percentage="0.5"><img class="pt-3 mt-5" src="{{ asset('img/img/car-finder/home/car.svg') }}" alt="Car"></div>
              <div class="position-absolute top-0 start-50 translate-middle-x h-100 overflow-hidden"><img src="{{ asset('img/img/car-finder/home/road-line.svg') }}" width="2" alt="Road line"></div>
            </div>
          </div>
            ...
            <div>
              <div class="card card-light card-hover h-100">
                <div class="card-img-top card-img-hover"><a class="img-overlay" href="car-finder-single.html"></a>
                  ...
                  <div class="content-overlay end-0 top-0 pt-3 pe-3">
                    <button class="btn btn-icon btn-light btn-xs text-primary rounded-circle" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to Wishlist"><i class="fi-heart"></i></button>
                  </div><img src="{{ asset('img/img/car-finder/catalog/04.jpg') }}" alt="Image">
                </div>
                <div class="card-body">
            ...
            <div>
              <div class="card card-light card-hover h-100">
                <div class="card-img-top card-img-hover"><a class="img-overlay" href="car-finder-single.html"></a>
                  ...
                  <div class="content-overlay end-0 top-0 pt-3 pe-3">
                    <button class="btn btn-icon btn-light btn-xs text-primary rounded-circle" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to Wishlist"><i class="fi-heart"></i></button>
                  </div><img src="{{ asset('img/img/car-finder/catalog/08.jpg') }}" alt="Image">
                </div>
                <div class="card-body">
            ...
            <div>
              <div class="card card-light card-hover h-100">
                <div class="card-img-top card-img-hover"><a class="img-overlay" href="car-finder-single.html"></a>
                  ...
                  <div class="content-overlay end-0 top-0 pt-3 pe-3">
                    <button class="btn btn-icon btn-light btn-xs text-primary rounded-circle" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to Wishlist"><i class="fi-heart"></i></button>
                  </div><img src="{{ asset('img/img/car-finder/catalog/03.jpg') }}" alt="Image">
                </div>
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between pb-1"><span class="fs-sm text-light me-3">2019</span>
                    <div class="form-check form-check-light">
            ...
            <div>
              <div class="card card-light card-hover h-100">
                <div class="card-img-top card-img-hover"><a class="img-overlay" href="car-finder-single.html"></a>
                  ...
                  <div class="content-overlay end-0 top-0 pt-3 pe-3">
                    <button class="btn btn-icon btn-light btn-xs text-primary rounded-circle" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to Wishlist"><i class="fi-heart"></i></button>
                  </div><img src="{{ asset('img/img/car-finder/catalog/02.jpg') }}" alt="Image">
                </div>
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between pb-1"><span class="fs-sm text-light me-3">2018</span>
                    <div class="form-check form-check-light">
              ...
              <div class="card card-body p-sm-5 card-light h-100">
                <div class="row align-items-center py-3 py-sm-0">
                  ...
                  <div class="col-md-8 col-xl-9">
                    <div class="row row-cols-2 row-cols-lg-4 gy-4 gx-3 gx-sm-4"><a class="col text-light text-decoration-none" href="#"><img class="d-block mb-2 mx-auto" src="{{ asset('img/img/car-finder/categories/01.png') }}" width="168" alt="Seat Covers">
                        <div class="fw-bold text-center pt-1">Seat Covers</div></a><a class="col text-light text-decoration-none" href="#"><img class="d-block mb-2 mx-auto" src="{{ asset('img/img/car-finder/categories/02.png') }}" width="168" alt="Tires">
                        <div class="fw-bold text-center pt-1">Tires</div></a><a class="col text-light text-decoration-none" href="#"><img class="d-block mb-2 mx-auto" src="{{ asset('img/img/car-finder/categories/03.png') }}" width="168" alt="Disks">
                        <div class="fw-bold text-center pt-1">Disks</div></a><a class="col text-light text-decoration-none" href="#"><img class="d-block mb-2 mx-auto" src="{{ asset('img/img/car-finder/categories/04.png') }}" width="168" alt="Child Seats">
                ...
                <div class="row align-items-center py-3 py-sm-0">
                  ...
                  <div class="col-md-6">
                    <div class="row row-cols-sm-3 row-cols-md-2 row-cols-lg-3 gy-4 gx-3 gx-sm-4">
                      <div class="col">
                        <div class="d-table bg-dark rounded-3 p-4 mx-auto mb-3"><img class="d-block m-sm-2" src="{{ asset('img/img/car-finder/icons/buyers.svg') }}" width="56" alt="Vetted buyers"></div>
                        <div class="fw-bold text-center">Vetted buyers</div>
                      </div>
                      <div class="col">
                        <div class="d-table bg-dark rounded-3 p-4 mx-auto mb-3"><img class="d-block m-sm-2" src="{{ asset('img/img/car-finder/icons/tools.svg') }}" width="56" alt="Smart tools"></div>
                        <div class="fw-bold text-center">Smart tools</div>
                      </div>
                      <div class="col">
                        <div class="d-table bg-dark rounded-3 p-4 mx-auto mb-3"><img class="d-block m-sm-2" src="{{ asset('img/img/car-finder/icons/handshake.svg') }}" width="56" alt="Handshake"></div>
...
<path d='M45.373 4.152c0 1.003-.241 1.88-.843 2.507a3.47 3.47 0 0 1-2.649 1.128 3.47 3.47 0 0 1-2.649-1.128c-.723-.752-1.084-1.629-1.084-2.757s.361-2.005 1.084-2.757A3.47 3.47 0 0 1 41.881.016c.482 0 .963.125 1.445.376s.843.501 1.084.877l-.602.627c-.482-.627-1.084-.877-1.927-.877-.723 0-1.445.251-1.927.877-.602.501-.843 1.253-.843 2.131s.241 1.629.843 2.131 1.204.877 1.927.877c.843 0 1.445-.251 2.047-.877.361-.376.602-.877.602-1.504h-2.649V3.651h3.492v.501zm5.54-3.134h-3.252V3.4h3.011v.877h-3.011v2.381h3.252v1.003h-4.215V.141h4.215v.877zm3.974 6.643h-.963V1.019h-2.047V.141h5.058v.877h-2.047v6.643zm5.54 0V.141h.963v7.52h-.963zm5.058 0h-.964V1.019h-2.047V.141h4.938v.877h-2.047v6.643h.121zm11.441-1.003a3.47 3.47 0 0 1-2.649 1.128 3.47 3.47 0 0 1-2.649-1.128c-.723-.752-1.084-1.629-1.084-2.757s.361-2.005 1.084-2.757A3.47 3.47 0 0 1 74.275.016a3.47 3.47 0 0 1 2.649 1.128c.722.752 1.084 1.629 1.084 2.757s-.361 2.005-1.084 2.757zm-4.576-.627c.482.501 1.204.877 1.927.877s1.445-.251 1.927-.877c.482-.501.843-1.253.843-2.131s-.241-1.629-.843-2.131C75.722 1.268 75 .892 74.277.892s-1.445.251-1.927.877c-.482.501-.843 1.253-.843 2.131s.241 1.629.843 2.131zm6.985 1.629V.141h1.084l3.492 5.891V.141h.963v7.52h-.963L80.176 1.52v6.142h-.843zm-9.034 11.032c-2.89 0-5.178 2.256-5.178 5.39 0 3.008 2.288 5.39 5.178 5.39s5.178-2.256 5.178-5.39c0-3.259-2.288-5.39-5.178-5.39zm0 8.523c-1.565 0-2.89-1.379-2.89-3.259s1.325-3.259 2.89-3.259 2.89 1.253 2.89 3.259c0 1.88-1.325 3.259-2.89 3.259zm-11.2-8.523c-2.89 0-5.178 2.256-5.178 5.39 0 3.008 2.288 5.39 5.178 5.39s5.178-2.256 5.178-5.39c0-3.259-2.288-5.39-5.178-5.39zm0 8.523c-1.566 0-2.89-1.379-2.89-3.259s1.325-3.259 2.89-3.259 2.89 1.253 2.89 3.259c0 1.88-1.325 3.259-2.89 3.259zm-13.367-6.894v2.
-1.203.584-1.388.306-.182.818-.218 1.521.191l.503-.864c-.897-.522-1.813-.616-2.535-.187C.19 1.931-.167 2.772-.167 3.754h1z' fill='#454056' mask='url(#C)'/></g><defs ><path id='E' d='M19.758 21.326L3.19 30.869c-.914.582-1.714.465-2.285 0l-.114.116.114.116c.571.465 1.371.582 2.285 0l16.568-9.775z'/><path id='F' d='M.79 30.869c-.343-.349-.457-.931-.457-1.629v.116c0 .698.229 1.28.571 1.629v-.116H.79zm24.681-12.801l-5.713 3.259.114.116 5.599-3.258c.8-.466 1.143-1.047 1.143-1.629 0 .582-.457 1.047-1.143 1.513z'/><path id='G' d='M3.19 2.125l22.281 12.917c.686.466 1.143.931 1.143 1.513 0-.582-.343-1.164-1.143-1.629L3.19 2.008C1.59 1.077.333 1.775.333 3.637v.116c0-1.746 1.257-2.56 2.857-1.629z'/></defs>
          ...
          <div class="col-md-5 col-lg-6"><img class="d-block mx-auto" src="{{ asset('img/img/car-finder/home/mobile-app.png') }}" width="460" alt="Mobile App"></div>
        </div>
      </section>
      <!-- Latest news (Blog)-->
      <section class="container pb-4 pb-sm-5 mb-2 mb-md-4">
        ...
        <div class="tns-carousel-wrapper tns-nav-outside tns-carousel-light">
          <div class="tns-carousel-inner" data-carousel-options="{&quot;items&quot;: 3, &quot;controls&quot;: false, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1, &quot;gutter&quot;: 16},&quot;500&quot;:{&quot;items&quot;:2, &quot;gutter&quot;: 18},&quot;900&quot;:{&quot;items&quot;:3, &quot;gutter&quot;: 20}, &quot;1100&quot;:{&quot;gutter&quot;: 24}}}">
            <div>
              <article><a class="d-block rounded-3 overflow-hidden" href="car-finder-blog-single.html"><img class="d-block" src="{{ asset('img/img/car-finder/blog/04.jpg') }}" alt="Image"></a>
                <div class="py-3"><a class="fs-xs text-uppercase text-decoration-none" href="#">Events</a>
                  <h3 class="text-light fs-base pt-1"><a class="nav-link" href="car-finder-blog-single.html">Top 10 Classic Car Events</a></h3><a class="d-flex align-items-center text-decoration-none" href="#"><img class="rounded-circle" src="{{ asset('img/img/avatars/08.jpg') }}" width="44" alt="Avatar">
                    <div class="ps-2">
            ...
            <div>
              <article><a class="d-block rounded-3 overflow-hidden" href="car-finder-blog-single.html"><img class="d-block" src="{{ asset('img/img/car-finder/blog/05.jpg') }}" alt="Image"></a>
                <div class="py-3"><a class="fs-xs text-uppercase text-decoration-none" href="#">Inspiration</a>
                  <h3 class="text-light fs-base pt-1"><a class="nav-link" href="car-finder-blog-single.html">5 Predictions From the Past About the Future</a></h3><a class="d-flex align-items-center text-decoration-none" href="#"><img class="rounded-circle" src="{{ asset('img/img/avatars/09.jpg') }}" width="44" alt="Avatar">
                    <div class="ps-2">
            ...
            <div>
              <article><a class="d-block rounded-3 overflow-hidden" href="car-finder-blog-single.html"><img class="d-block" src="{{ asset('img/img/car-finder/blog/06.jpg') }}" alt="Image"></a>
                <div class="py-3"><a class="fs-xs text-uppercase text-decoration-none" href="#">Test Drives</a>
                  <h3 class="text-light fs-base pt-1"><a class="nav-link" href="car-finder-blog-single.html">This Year is All About New Harley Davidson</a></h3><a class="d-flex align-items-center text-decoration-none" href="#"><img class="rounded-circle" src="{{ asset('img/img/avatars/12.jpg') }}" width="44" alt="Avatar">
                    <div class="ps-2">
